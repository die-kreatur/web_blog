...
urlpatterns = [
    ...
    path('logout/', auth_views.LogoutView.\
        as_view(template_name='users/logout.html'), name='logout'),
    path('profile/', users_views.profile, name='profile'),
    path('password-reset/', auth_views.PasswordResetView.\
        as_view(template_name='users/password_reset.html'), name='password_reset'),
    path('password-reset/success', auth_views.PasswordResetDoneView.\
    ...
    path('blog_members/', users_views.users_list, name='blog-members'),
]
